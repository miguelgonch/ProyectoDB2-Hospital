...
public class DeletePatient extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Send data
            URL url = new URL("http://25.65.236.60:8080/proyectoDB2-Hospital1/restP/patient/deletePatient");
            ...
            if (answ == 1) {
                response.sendRedirect("http://25.65.236.60:8080/proyectoDB2-Hospital1/pacientes_h.jsp?del=1");
            } else {
                response.sendRedirect("http://25.65.236.60:8080/proyectoDB2-Hospital1/pacientes_h.jsp?del=0");
            }
            wr.close();
            rd.close();
        } catch (Exception e) {
