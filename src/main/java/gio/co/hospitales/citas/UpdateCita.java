...
public class UpdateCita extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (answ == 1) {
                response.sendRedirect("http://localhost:8082/proyectoDB2-Hospital1/citas_h.jsp?up=1");
            } else {
                response.sendRedirect("http://localhost:8082/proyectoDB2-Hospital1/citas_h.jsp?up=0");
            }
